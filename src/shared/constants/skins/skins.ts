...
export const snakeSkins: readonly SnakeSkin[] = [
...

  {
    ...
    tint: blendColorSequence(
      [palette.red, palette.mauve, palette.blue, palette.mauve],
      16,
    ),
  },

  {
    ...
    price: 750,
    tint: blendColorSequence(
      [palette.mauve, palette.red, palette.peach, palette.red],
      16,
    ),
  },
...

  {
    ...
    price: 3500,
    tint: blendColorSequence(
      [Color3.fromRGB(186, 51, 84), Color3.fromRGB(94, 41, 153)],
      16,
    ),
