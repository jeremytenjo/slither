...
export function Controller() {
  ...
  return (
    <>
      {device === 'keyboard' && (
        <Mouse updateAngle={updateAngle.run} setBoost={setBoost.run} />
      )}
      {device === 'touch' && (
        <Touch updateAngle={updateAngle.run} setBoost={setBoost.run} />
      )}
      {device === 'gamepad' && (
        <Gamepad updateAngle={updateAngle.run} setBoost={setBoost.run} />
      )}
    </>
  )
}
